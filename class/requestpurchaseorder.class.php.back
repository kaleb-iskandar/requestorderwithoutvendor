...
class RequestPurchaseOrder extends CommonObject
{
	 ...
	 */
	public $module = 'requestorderwithoutvendor';
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		/*if (! ((empty($conf->global->MAIN_USE_ADVANCED_PERMS) && !empty($user->rights->requestorderwithoutvendor->write))
		 || (!empty($conf->global->MAIN_USE_ADVANCED_PERMS) && !empty($user->rights->requestorderwithoutvendor->requestorderwithoutvendor_advance->validate))))
		 {
	...
	*/
	...
	public function getLinesArray()
	{
		...
		$result = $objectline->fetchAll('ASC', 'position', 0, 0, array('customsql'=>'fk_requestpurchaseorder = '.((int) $this->id)));
	...
	public function getNextNumRef()
	{
		...
		if (!empty($conf->global->REQUESTORDERWITHOUTVENDOR_REQUESTPURCHASEORDER_ADDON)) {
			...
			foreach ($dirmodels as $reldir) {
				$dir = dol_buildpath($reldir."core/modules/requestorderwithoutvendor/");
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		$modelpath = "core/modules/requestorderwithoutvendor/doc/";
...
/**
 * Class RequestPurchaseOrderLine. You can also remove this and generate a CRUD class for lines objects.
 */
class RequestPurchaseOrderLine extends CommonObjectLine
{
	// To complete with content of an object RequestPurchaseOrderLine
	// We should have a field rowid, fk_requestpurchaseorder and position
