...
/**
 * \file    requestorderwithoutvendor/core/boxes/requestorderwithoutvendorwidget1.php
 * \ingroup requestorderwithoutvendor
 * \brief   Widget provided by RequestOrderWithoutVendor
 *
 ...
 */
class requestorderwithoutvendorwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "requestorderwithoutvendorbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "requestorderwithoutvendor@requestorderwithoutvendor";
	 ...
	 */
	public $depends = array('requestorderwithoutvendor');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "requestorderwithoutvendor@requestorderwithoutvendor"));
		...
		//$this->hidden = ! ($user->rights->requestorderwithoutvendor->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/requestorderwithoutvendor/class/requestorderwithoutvendor.class.php");

		// Populate the head at runtime
		$text = $langs->trans("RequestOrderWithoutVendorBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_requestorderwithoutvendor@requestorderwithoutvendor',
