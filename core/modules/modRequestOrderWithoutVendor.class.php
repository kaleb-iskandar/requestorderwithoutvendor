...
/**
 * 	\defgroup   requestorderwithoutvendor     Module RequestOrderWithoutVendor
 *  \brief      RequestOrderWithoutVendor module descriptor.
 *
 *  \file       htdocs/requestorderwithoutvendor/core/modules/modRequestOrderWithoutVendor.class.php
 *  \ingroup    requestorderwithoutvendor
 *  \brief      Description and activation file for module RequestOrderWithoutVendor
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';

/**
 *  Description and activation class for module RequestOrderWithoutVendor
 */
class modRequestOrderWithoutVendor extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->rights_class = 'requestorderwithoutvendor';
		...
		// Module label (no space allowed), used if translation string 'ModuleRequestOrderWithoutVendorName' not found (RequestOrderWithoutVendor is name of module).
		...
		// Author
		$this->editor_name = 'Kampoeng Kopi Banaran';
		$this->editor_url = '';
		...
		// Key used in llx_const table to save module status enabled/disabled (where REQUESTORDERWITHOUTVENDOR is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'js' => array(
				//   '/requestorderwithoutvendor/js/requestorderwithoutvendor.js.php',
			),
		...
		// Example: this->dirs = array("/requestorderwithoutvendor/temp","/requestorderwithoutvendor/subdir");
		$this->dirs = array("/requestorderwithoutvendor/temp");

		// Config pages. Put here list of php page, stored into requestorderwithoutvendor/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@requestorderwithoutvendor");
		...
		$this->langfiles = array("requestorderwithoutvendor@requestorderwithoutvendor");
		...
		//$this->automatic_activation = array('FR'=>'RequestOrderWithoutVendorWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('REQUESTORDERWITHOUTVENDOR_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('REQUESTORDERWITHOUTVENDOR_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isset($conf->requestorderwithoutvendor) || !isset($conf->requestorderwithoutvendor->enabled)) {
			$conf->requestorderwithoutvendor = new stdClass();
			$conf->requestorderwithoutvendor->enabled = 0;
		}
		...
		$this->dictionaries=array(
			...
			'tabcond'=>array($conf->requestorderwithoutvendor->enabled, $conf->requestorderwithoutvendor->enabled, $conf->requestorderwithoutvendor->enabled),
		...
		*/
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in requestorderwithoutvendor/core/boxes that contains a class to show a widget.
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'requestorderwithoutvendorwidget1.php@requestorderwithoutvendor',
			//      'note' => 'Widget provided by RequestOrderWithoutVendor',
		...
		$this->cronjobs = array(
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => '$conf->requestorderwithoutvendor->enabled',
			//      'priority' => 50,
			//  ),
		);
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'$conf->requestorderwithoutvendor->enabled', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'$conf->requestorderwithoutvendor->enabled', 'priority'=>50)
		// );
		...
		$this->menu[$r++] = array(
			...
			'titre'=>'ModuleRequestOrderWithoutVendorName',
	...
	public function init($options = '')
	{
		...
		//$result = $this->_load_tables('/install/mysql/', 'requestorderwithoutvendor');
		$result = $this->_load_tables('/requestorderwithoutvendor/sql/');
		if ($result < 0) {
		...
		//$result1=$extrafields->addExtraField('requestorderwithoutvendor_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', 0, 0, '', '', 'requestorderwithoutvendor@requestorderwithoutvendor', '$conf->requestorderwithoutvendor->enabled');
		//$result2=$extrafields->addExtraField('requestorderwithoutvendor_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', 0, 0, '', '', 'requestorderwithoutvendor@requestorderwithoutvendor', '$conf->requestorderwithoutvendor->enabled');
		//$result3=$extrafields->addExtraField('requestorderwithoutvendor_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', 0, 0, '', '', 'requestorderwithoutvendor@requestorderwithoutvendor', '$conf->requestorderwithoutvendor->enabled');
		//$result4=$extrafields->addExtraField('requestorderwithoutvendor_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', 0, 0, '', '', 'requestorderwithoutvendor@requestorderwithoutvendor', '$conf->requestorderwithoutvendor->enabled');
		//$result5=$extrafields->addExtraField('requestorderwithoutvendor_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', 0, 0, '', '', 'requestorderwithoutvendor@requestorderwithoutvendor', '$conf->requestorderwithoutvendor->enabled');
