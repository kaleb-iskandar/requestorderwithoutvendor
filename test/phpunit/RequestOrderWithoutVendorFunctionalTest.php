...
/**
 * \file    test/phpunit/RequestOrderWithoutVendorFunctionalTest.php
...
/**
 * Class RequestOrderWithoutVendorFunctionalTest
 *
 ...
 *
 * @package Testrequestorderwithoutvendor
 */
class RequestOrderWithoutVendorFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modRequestOrderWithoutVendor')->click();
		} else {
			// Disable the module
			$this->byHref('modRequestOrderWithoutVendor')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/requestorderwithoutvendor/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('requestorderwithoutvendor/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/requestorderwithoutvendor/admin/about.php');
		$this->authenticate();
		return $this->assertContains('requestorderwithoutvendor/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('requestorderwithoutvendorwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modRequestOrderWithoutVendor_RequestOrderWithoutVendorTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modRequestOrderWithoutVendor_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
