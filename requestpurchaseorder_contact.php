...
/**
 *  \file       requestpurchaseorder_contact.php
 *  \ingroup    requestorderwithoutvendor
 *  \brief      Tab for contacts linked to RequestPurchaseOrder
 */
...
$hookmanager->initHooks(array('requestpurchaseordercontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($enablepermissioncheck) {
	...
	$permission = $user->rights->requestorderwithoutvendor->requestpurchaseorder->write;
} else {
	$permissiontoread = 1;
	$permission = 1;
}
...
$title = $langs->trans('RequestPurchaseOrder')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("RequestPurchaseOrder"), -1, $object->picto);
