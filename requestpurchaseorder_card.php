...
if (empty($reshook)) {
	...
	$triggersendname = 'REQUESTORDERWITHOUTVENDOR_REQUESTPURCHASEORDER_SENTBYMAIL';
	$autocopy = 'MAIN_MAIL_AUTOCOPY_REQUESTPURCHASEORDER_TO';
	...
	*/
	...
	if ($action != 'presend') {
		...
		if ($includedocgeneration) {
			...
			$filedir = $conf->requestorderwithoutvendor->dir_output.'/'.$object->element.'/'.$objref;
